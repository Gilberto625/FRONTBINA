...
export class AuthService {
  ...
  constructor(
    ...
    // Obtener CSRF token al inicializar el servicio
    this.getCsrfToken().subscribe({
      next: () => console.log('CSRF token obtenido'),
      error: (err) => console.error('Error obteniendo CSRF token:', err)
    });
  }
  ...
  /**
   * Cerrar sesión - ahora llama al backend para invalidar la sesión
   */
  ...
  /**
   * Cerrar sesión solo localmente (sin llamar backend)
